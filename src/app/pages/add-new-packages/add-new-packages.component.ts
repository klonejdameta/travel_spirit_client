      ...
      .subscribe((response: any) => {
        if (response.success) {
          ...
          this.messageService.add({
            ...
            detail: "City is created successfully."
          });
          this.clearCityForm();
          this.getCities();
        } else {
      ...
      .subscribe((response: any) => {
        if (response.success) {
          ...
          this.messageService.add({
            severity: 'success',
            summary: 'Action was success',
            detail: "Package is added successfully!"
          });
          this.clearForm();
        } else {
          this.messageService.add({
            severity: 'warn',
            summary: 'Adding package errors',
            detail: response.messages ? response.messages.join(", ") : "Unknown error"
          });
          this.loader = false;
        }
